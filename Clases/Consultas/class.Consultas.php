...
//************* PARTE II ******************	
	...
	public function get_form($IdConsulta = NULL){
		...
		<tr align="center">
						<th colspan="2"><button class="btn btn-outline-success"><a href="consultas.php">Regresar</a></button></th>
					</tr>	
				<tr>
					<th colspan="2" class="text-center align-middle  table-info">DATOS DE LAS CONSULTAS</th>
				</tr>
	...
	public function get_list(){
		...
		<table class="table table-hover table-bordered text-center align-middle table-secondary" >
			<tr>
				<th colspan="8" class="text-center align-middle table-info">LISTA DE LAS CONSULTAS</th>
			</tr>
			<tr>
		...
		while($row = $res->fetch_assoc()){
			...
			$html .= '
				...
				<td>' . $row['diagnostico'] . '</td>
					<td><button class="btn btn-outline-danger"><a href="consultas.php?d=' . $d_del_final . '">Borrar</a></button></td>
	...
	public function get_detail_consulta($IdConsulta){
        ...
        if($num==0){
            ...
            echo $this->_message_error($mensaje);
				...
				<table  border="2" align="center" class=" table-secondary" >
                <tr>
						<th colspan="2"  class="text-center table-info">DATOS DE LA CONSULTA</th>
					</tr>
					<tr>
					<td>IdPaciente: </td>
					<td>' . $row['pacientes'] . '</td>
