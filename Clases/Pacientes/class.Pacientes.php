...
//************* PARTE II ******************	
	...
	public function get_form($IdPaciente = NULL){
		...
		<tr align="center">
						<th colspan="2"><button class="btn btn-outline-success"><a href="pacientes.php">Regresar</a></button></th>
					</tr>	
				<tr>
					<th colspan="2" class="text-center align-middle  table-info">DATOS DE LOS PACIENTES</th>
				</tr>
	...
	public function get_list(){
		...
		<table class="table table-hover table-bordered text-center align-middle table-secondary" >
			<tr>
				<th colspan="8" class="text-center align-middle table-info">LISTA DE LOS PACIENTES</th>
			</tr>
			<tr>
	...
	public function get_detail_pacientes($IdPaciente){
        ...
        if($num==0){
            ...
            echo $this->_message_error($mensaje);
				...
				<table  border="2" align="center" class=" table-secondary" >
                <tr>
						<th colspan="2"  class="text-center table-info">DATOS DE LOS PACIENTES</th>
					</tr>
                <tr>
                    <td>Id Paciente: </td>
